class BarGraph {
    ...
    dataForSecondViz(neededData, selected){
        ...
        document.getElementById("comparisonGroupedBarGraph").style.outline = "5px dashed black"
        document.getElementById("comparisonGroupedBarGraph").style.left = barGraphStarter
        document.getElementById("comparisonGroupedBarGraph").style.top = "450px"
        document.getElementById("comparisonGroupedBarGraph").style.width = assignedWidth
        document.getElementById("comparisonGroupedBarGraph").style.height = "300px"
...
async function getData(selected, countries){
    ...
    let api_address = 'http://128.110.218.53/comparison?cluster='+givenValue+'&cc='+countries+'&period='+givenValue2+'&range='+selected.join(',')
